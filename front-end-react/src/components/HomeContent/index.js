...
const HomeContent = () => {
  // Criando um estado para a lista de filmes
  const [films, setFilms] = useState([]);

  // useEffect: buscar filmes uma vez ao montar o componente
  useEffect(() => {
              ...
              <article key={film._id} className={styles.filmCard}>
                <div className={styles.posterWrap}>
                  <img
                    ...
                    src={film.poster || `/images/${film.imagem}`}
                ...
                <div className={styles.info}>
                  ...
                  <p className={styles.synopsis}>{film.synopsis || "Sem sinopse disponível."}</p>
