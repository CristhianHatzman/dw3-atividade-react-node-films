...
const createFilm = async (req, res) => {
  try {
    // proteção: garantir que o corpo da requisição exista e seja JSON
    if (!req.body || Object.keys(req.body).length === 0) {
      console.log("createFilm: corpo vazio ou Content-Type não definido", req.headers["content-type"]);
